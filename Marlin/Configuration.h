...
#define DELTA
  ...
  #define DELTA_HEIGHT 327.74 // get this value from auto calibrate
  ...
  #define DELTA_RADIUS 97.34
  
  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -1.18, 0.11, 0.0 } // get these values from auto calibrate

    #define DELTA_ENDSTOP_ADJ { -1.12, 0.0, -1.72 } // get these from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -12.49  // Z offset: -below +above  [the nozzle]
